        ...
        >
          ...
          <p className="text-sm xs:text-base sm:text-lg md:text-xl text-gray-600 max-w-xs xs:max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-3xl mx-auto px-2 xs:px-0 leading-relaxed">
            ...
            <span className="sm:hidden">
              World-class coaching staff with elite experience developing football talent
            </span>
          </p>
        </motion.div>
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4 xs:space-y-5 sm:space-y-6">
                ...
                <div className="relative">
                  ...
                  />
                  <div className={`absolute -bottom-1 -right-1 xs:-bottom-2 xs:-right-2 w-8 h-8 xs:w-10 xs:h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${member.color} rounded-full flex items-center justify-center shadow-md xs:shadow-lg`}>
                ...
                <div className="space-y-2 xs:space-y-3">
                  ...
                  <p className="text-sm xs:text-base sm:text-lg text-gray-700 leading-relaxed max-w-2xl">
                    {member.bio}
                  </p>
                </div>
